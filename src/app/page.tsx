  ...
  return (
      <main className="p-6 relative">
        ...
        <h1 className="text-3xl font-bold mb-4 flex justify-center">
          Willkommen zu Flo&apos;s Pokedex
        </h1>

        <SearchBar value={search} onChange={(e) => setSearch(e.target.value.toLowerCase())} />

        <TypeButtonGroup selectedTypes={selectedTypes} setSelectedTypes={setSelectedTypes} />
        ...
        {loading && pokemons.length === 0 ? (
            ...
            <>
              ...
              {hasMore && (
                  <LoadMoreButton onClick={loadMorePokemon} isLoading={isLoadingMore} />
              )}
            </>
        )}
      </main>
